package com.rjpard.spring5recipeapp.bootstrap;

import com.rjpard.spring5recipeapp.domain.*;
import com.rjpard.spring5recipeapp.repositories.CategoryRepository;
import com.rjpard.spring5recipeapp.repositories.RecipeRepository;
import com.rjpard.spring5recipeapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setUrl(("http://wwww.simplyrecipes.com/recipes/perfect_guacamole/"));
        guacRecipe.setServings(4);
        guacRecipe.setSource("$");
